...
const SkillBar: React.FC<{
  ...
  return (
    <motion.div
      ...
      className="mb-4 transform transition-all duration-300 hover:shadow-lg rounded-lg p-3"
    >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto mt-12">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-primary-800 p-6 rounded-xl shadow-md transform transition-all duration-300"
          >
